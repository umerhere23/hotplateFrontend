...
export default function SettingsPage() {
    ...
    return (
        <div className="mt- mb-2 max-w-7xl mx-auto">
            <h1 className="text-2xl font-semibold mb-6">Settings</h1>
            <div className="grid grid-cols-1 lg:grid-cols-[35%_32.5%_32.5%] gap-3">
                <div className="space-y-3">
                    ...
                    <section className="bg-white p-4 rounded-lg shadow border border-gray-200">
                        ...
                        <div className="border border-gray-200 rounded-md p-3 flex justify-between items-center">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                <div className="w-10 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:bg-orange-400"></div>
                    ...
                    {/* Team */}
                    <section className="bg-white p-4 rounded-lg shadow border border-gray-200">
                        <h2 className="text-lg font-medium mb-3">Your Team</h2>
                        {users.map((user, idx) => (
                            <div
                                key={idx}
                                className="flex items-center w-[375px] justify-between p-3 rounded-lg border border-gray-200 shadow-sm mb-3 bg-white"
                            >
                                <div>
                ...
                <div className="space-y-3">
                    {/* Storefront */}
                    < section className="bg-white p-4 rounded-lg shadow border border-gray-200" >
                        <h2 className="text-lg font-medium mb-3">Storefront</h2>
                            ...
                            <div className="mt-4 space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" className="sr-only peer" />
                                        <div
                                            className="w-10 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:bg-orange-400"></div>
                                        <div className="absolute left-0.5 top-0.5 w-4 h-4 bg-white rounded-full shadow peer-checked:translate-x-5 transition"></div>
                                    </label>
                        ...
                        <div className="border rounded-md mt-4 border-gray-300 p-4">
                            ...
                            <div className="flex justify-between">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" className="sr-only peer" />
                                    <div className="w-10 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:bg-orange-400"></div>
                                    <div className="absolute left-0.5 top-0.7 w-4 h-4 bg-white rounded-full shadow peer-checked:translate-x-5 transition"></div>
                                </label>
                            </div>
                    ...
                    {/* Drop Controls */}
                    <section className="bg-white p-4 rounded-lg shadow border border-gray-200" >
                        <h2 className="text-lg font-medium mb-3">Drop Controls</h2>
                        ...
                        <div className="flex items-center  py-4">
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" className="sr-only peer" />
                                <div className="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-orange-400"></div>
                ...
                <div className="space-y-3">
                    <section className="bg-white p-4 rounded-lg shadow border border-gray-200" >
                        <h2 className="text-lg font-medium mb-3">SMS Notifications</h2>
                        <div className="mb-3 w-[380px]">
                            ...
                            <textarea
                                ...
                                className={`w-[380px] h-30 p-3 text-sm border rounded-md focus:outline-none focus:ring-2
                                ${confirmationEnabled
                        ...
                        <div className="mb-3 w-[380px]">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    ...
                                    />
                                    <div className="w-10 h-5 bg-gray-200 rounded-full peer-checked:bg-orange-400 transition-colors"></div>
                                    <div className="absolute left-0.5 top-0.5 w-4 h-4 bg-white rounded-full shadow peer-checked:translate-x-5 transition"></div>
                                </label>
                            </div>
                            <textarea
                                ...
                                className={`w-full h-30 p-3 text-sm border rounded-md focus:outline-none focus:ring-2
                                ${reminder24Enabled
                                        ? "bg-white border-gray-300 text-gray-700 focus:ring-indigo-500"
                                        : "bg-gray-100 border-gray-200 text-gray-400 cursor-not-allowed"
                                    }`}
                        ...
                        <div className="bg-blue-100 text-sm text-gray-700 border border-blue-100 rounded-md p-3 mb-3 flex items-start gap-2">
                            <Info className="w-4 h-4 text-blue-500 mt-0.5" />
                            <p>
